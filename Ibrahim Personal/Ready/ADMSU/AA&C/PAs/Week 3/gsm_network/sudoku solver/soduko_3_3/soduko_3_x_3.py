...
# This is a method which given a list of literals writes doen clauses that express the fact
...
def exactly_one_of(literals):
    ...
    for pair in itertools.combinations(literals, 2): # then for all pair of literals we add a clause containing two negated literals from this list
...
with open('soduko_3_3.cnf', 'w') as f: # Namely, we open a file, tmp.cnf  
...
os.system("minisat soduko_3_3.cnf soduko_3_3.sat")

# then we open the satisying assignment file and read the first line 

with open ("soduko_3_3.sat", "r") as satfile:
    for line in satfile:
