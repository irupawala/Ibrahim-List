...
'''
This Problem is exactly similar to previous Problem. Instead of comparing hash values once (Probability of Collision |P|/p we 
compare the hash values Twice (|P|/m1)(|P|/m2) to reduce the probability of collision even further

Time Complexity - O(|T|+(q+1)|P|)
Running time of computeHashes is O(|T|+|P|) +  O(|T|+|P|) for two prime numbers
