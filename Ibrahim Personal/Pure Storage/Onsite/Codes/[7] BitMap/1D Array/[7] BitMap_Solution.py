...
if __name__ == "__main__":
    ...
    print(f"Input = {A}")
    #print(f"clBOp = {clearBits(A, 8, 2)}") # clear the bits in the range from offset to offset + length - 1
    print(f"stBOp = {setBits(A, 10, 1)}") # clear the bits in the range from offset to offset + length - 1