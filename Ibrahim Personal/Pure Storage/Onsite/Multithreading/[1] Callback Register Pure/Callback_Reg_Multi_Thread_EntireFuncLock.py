...
3. If you remove locks from this code then as soon as event is fired other threads will start getting into queue again and also 
won't wait for the current elements in the queue to be executed which is unexpected
'''
